...
5. **회고 본문** — 짧게 남긴다. 서로 역할이 다른 **2개 단락**, 합계 3~4문장·시각상 3~4줄로 쓴다. 첫 단락은 그날 실제 장면과 구체를, 둘째 단락은 그 장면이 남긴 판단 또는 다음 장면으로의 전환을 쓴다. 21px/400/line-height 1.58, 부드러운 회색 `#d6d1c8`; 단락 사이는 14px만 띄운다. 사실을 반복하거나 감탄사·격언으로 분량을 채우지 않는다.
...
- 회고: **84~120자 권장**. 2개 단락의 합계이며, 첫 단락은 관찰·사실, 둘째 단락은 그 사실이 바꾼 판단 또는 다음 전환을 담는다. 4줄을 넘기면 중복 문장을 덜고 줄바꿈을 다듬는다. 감탄사·자기계발 격언·AI 운영 용어를 피한다.
