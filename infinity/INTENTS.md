...
### marketing-04 · Virtue 첫인상 포지셔닝 스냅샷 작성
- id: marketing-04
- status: in_progress
- priority: high
- permission: L1
- project: virtue-rebirth-app
- created: 2026-05-19T10:00Z
- promoted_to_active: 2026-05-19T10:30Z
- goal: Superhuman PMF 엔진·April Dunford 포지셔닝·NN/g 첫인상 프레임워크를 적용해 Virtue의 제품 범주/약속/반론/첫인상 리스크를 한 문서로 정리한다.
- success_criteria: 3개 포지셔닝 가설, 첫인상 리스크, PMF 질문 초안 4개, 헤드라인/보조문구 후보 3개를 한 문서에 정리
- source: /home/ubuntu/dev/knowledge-lab/source/external-links/marketing/2026-05-19-prelaunch-positioning-pmf.md
