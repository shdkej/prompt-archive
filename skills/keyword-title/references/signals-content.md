...
여행·라이프스타일 시드는 research-37의 제목 학습을 적용한다. 제목 후보가 장소 감상, 일정 나열, 맛집/팁/필수영상, 4K/무편집 형식에 머물면 PlatformFit과 EmotionalTrigger를 낮게 본다. 비용, 변화, 불편, 삶의 선택, 관계 사건 중 하나가 독자의 판단값으로 들어가야 한다.

좋은 후보는 `장소명 + 선택 압력 + 기대와 다른 결론` 구조를 가진다. 예: `[도시]는 예쁜데, 살겠냐고 물으면 답이 달라진다`, `[도시]에서 돈보다 먼저 아껴야 했던 것`.
