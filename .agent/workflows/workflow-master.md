...
[패널 토론 / 브레인스토밍]
    ↓
[Planner 단계]
├── docs/product/PERSONA.md 생성
├── docs/product/PRD.md 생성
└── docs/dev/STORYBOARD.md 생성
    ↓
[Developer 단계]
├── docs/dev/ARCHITECTURE.md 생성
├── docs/dev/DESIGN_SYSTEM.md 생성
├── docs/dev/ERD.md 생성
└── docs/dev/API.md 생성 (API 있는 경우)
    ↓
[Marketer 단계]
├── docs/product/BRAND.md 생성
├── docs/product/STP.md 생성
├── docs/ops/MARKETING.md 생성
└── docs/ops/LAUNCH.md 생성
    ↓
[Operator 단계]
